...
async function startPanelBot() {
  if (!SESSION_ID) {
    ...
    console.log('┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛');
    console.log('');
    console.log('  ⚠ SESSION_ID env var is not set.');
    console.log('  Pair first on the MEGH pairing site to get a session ID,');
    console.log('  then set it as the SESSION_ID variable on this server\'s');
    console.log('  Startup tab in the panel, then click Restart.');
    console.log('');
    console.log('  Pairing site: https://megh-pairing.onrender.com');
    console.log('');
    console.log('  Format: megh-ultra:~XXXXXXXXXXXXXXXXX');
    console.log('');
    // Sleep forever — let the user update env vars via the panel Startup tab
    setInterval(() => {
      console.log(`[PANEL] Still waiting for SESSION_ID... (${new Date().toISOString()})`);
    }, 60000);
    return;
  }
  ...
  console.log('┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓');
  console.log('┃  MEGH ULTRA — Panel Mode                            ┃');
  console.log(`┃  Session: ${SESSION_ID.slice(0, 36).padEnd(36)} ┃`);
  console.log('┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛');
  console.log('');
  ...
  if (authFiles.length === 0) {
    try {
      ...
      console.error('[PANEL] Retrying in 30s...');
      setTimeout(() => startPanelBot(), 30000);
      return;
    }
  } else {
